...
namespace Application.Services
{
    public class PostService : IPostService
    {
        ...
        public async Task <IEnumerable<PostDto>> GetAllPostsAsync(int pageNumber, int pageSize, string sortField, bool aescending)
        {
            var posts = await _postRepository.GetAllAsync(pageNumber, pageSize, sortField, aescending);
